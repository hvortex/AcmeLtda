...
public class AcmeLtda {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Digite EM LITROS, a quantidade de água ja ingerida hoje");
            ...
            System.out.println(String.format("%s\nVocê pesa: %.0fKg\nHoje você ja ingeriu: %.0f Litros de água\nA quantidade ideal de água para você beber por dia é: %.0f Litros", nome, peso, AguaIngeridaHoje, QuantidadeIdeal));

        if (FaltaIngerir<=0) {
            System.out.println("Parabéns, você atingiu a meta de hidratação diária");
        } else {
            System.out.println(String.format("Continue focado em se hidratar por hoje, ainda faltam: %.0f litros! Você consegue!",FaltaIngerir));
        }
